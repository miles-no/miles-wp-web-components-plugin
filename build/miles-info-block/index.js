...
/***/ "./src/miles-info-block/MilesInfoBlockWrapper.js":
/*!*******************************************************!*\
  !*** ./src/miles-info-block/MilesInfoBlockWrapper.js ***!
  \*******************************************************/
...
const MilesInfoBlockWrapper = props => {
  const milesInfoBlockRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    const milesInfoBlock = milesInfoBlockRef.current;

    // Set the 'heading' attribute if it's passed as a prop
    if (props.heading) {
      milesInfoBlock.setAttribute('heading', props.heading);
    }

    // Clean up
    return () => {
      if (props.heading) {
        milesInfoBlock.removeAttribute('heading');
      }
    };
  }, [props.heading]);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("miles-info-block", {
    ref: milesInfoBlockRef
  }, props.children);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MilesInfoBlockWrapper);
...
/* harmony import */ var _MilesInfoBlockWrapper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./MilesInfoBlockWrapper */ "./src/miles-info-block/MilesInfoBlockWrapper.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/miles-info-block/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./block.json */ "./src/miles-info-block/block.json");
